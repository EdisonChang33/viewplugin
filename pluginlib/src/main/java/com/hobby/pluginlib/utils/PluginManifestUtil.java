...
public class PluginManifestUtil {
	public static void setManifestInfo(Context context, String apkPath, PluginInfo info)
		...
		File libDir = PluginHelper.getInstance().getPluginLibPath(info);
		try {
			if (libDir != null && extractLibFile(zipFile, libDir)) {
